...
const menuItems = [ 
  {
    ...
    items: [
      ...
      { name: 'Ordens de Servico', href: '/servicos', icon: ClipboardList, badge: 12 },
    ],
  },
  {
    title: 'Clientes',
    items: [
      { name: 'Lojas Parceiras', href: '/lojas', icon: Building2 },
      { name: 'Particulares', href: '/clientes', icon: UserCircle },
    ],
  },
  {
    title: 'Equipe',
    items: [
      { name: 'Montadores', href: '/montadores', icon: Users },
  ...
  },
  {
    title: 'Financeiro',
    items: [
      { name: 'Visao Geral', href: '/financeiro', icon: Wallet },
      { name: 'Salarios', href: '/financeiro/salarios', icon: DollarSign },
